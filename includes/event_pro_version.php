        ...
        <div class="metabox-holder" style="width:98%; float:left;">
            <div id="namediv" class="stuffbox" style="width:60%;min-height:450px;">
              ...
              <div style="padding-top:15px;margin-left:20px;">
                <a class="btnprover" target="_blank" href="http://upscalethought.com/products/booking/" style="width:100px;height: 20px;background-color: green;color:white;" >Wordpress Event Booking Manager Pro</a>
              </div>  
